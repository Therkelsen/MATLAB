...
disp(' ')
disp(' ')
disp('LQR with Integral Control')
% I'm not fully sure that this is the correct C matrix. I assumed 1,0
% because we want to control state 1, in which there's terms for state 2,
% i.e. the actuator.
C = [1, 0];
D = 0;
