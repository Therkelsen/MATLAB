...
plot(X(:,1),X(:,2),'k*','LineWidth',1),xlim([0 10]),ylim([0 10]),grid,axis square,xlabel('x_1','Fontsize',14),ylabel('x_2','Fontsize',14)
subplot(7,8,9:10)
axis off
text(0.23,0.8,'Observations','Fontsize',20)
text(0.3,-0.1,['n = ' num2str(n) , ', p = 2'],'Fontsize',14)
%----------------------------------------------------
...
K = 3
disp('---------------------------------------------------------------------')
obj3 = gmdistribution.fit(X,K,'Start','randSample','Replicates',10);
...
contour(x1,x2,F3),axis square,axis([0 10 0 10]),xlabel('x_1','Fontsize',14); ylabel('x_2','Fontsize',14)
subplot(7,8,12:13)
axis off
...
plot(K3_cluster_1(:,1),K3_cluster_1(:,2),'r*','LineWidth',1),xlim([0 10]),ylim([0 10]),grid,axis square,xlabel('x_1','Fontsize',14),ylabel('x_2','Fontsize',14)
hold on
...
K = 2
disp('---------------------------------------------------------------------')
obj2 = gmdistribution.fit(X,K,'Start','randSample','Replicates',10);
...
%--------------------------------
subplot(7,8,[44 45 52 53])
contour(x1,x2,F2),axis square,axis([0 10 0 10]),xlabel('x_1','Fontsize',14); ylabel('x_2','Fontsize',14)
subplot(7,8,12:13)
axis off
text(0,0.8,['K = ' num2str(K) ':  Estimation of GMM'],'Fontsize',20)
text(-0.15,0.45,'(see estimated parameters p_k, {\mu}_k, {\Sigma}_k in Command Window)','Fontsize',12)
...
subplot(7,8,[23 24 31 32])
plot(K2_cluster_1(:,1),K2_cluster_1(:,2),'r*','LineWidth',1),xlim([0 10]),ylim([0 10]),grid,axis square,xlabel('x_1','Fontsize',14),ylabel('x_2','Fontsize',14)
hold on
...
text(0.3,-0.1,['n = ' num2str(n) , ', p = 2'],'Fontsize',14)
%----------------------------------------------------
% K = 4: estimate parameters for MVN's
%----------------------------------------------------
disp('  ')
disp('  ')
disp('  ')
...
K = 4
disp('---------------------------------------------------------------------')
obj4 = gmdistribution.fit(X,K,'Start','randSample','Replicates',10);
estimated_priors = obj4.PComponents
disp('---------------------------------------------------------------------')
estimated_mean_vectors = obj4.mu
disp('---------------------------------------------------------------------')
estimated_covariance_matrices = obj4.Sigma
disp('---------------------------------------------------------------------')
%----------------------------------------------------
% K = 4: plot estimated pdf and contour
%----------------------------------------------------
p1_hat = obj4.PComponents(1);
mu1_hat = obj4.mu(1,:);
Sigma1_hat = obj4.Sigma(:,:,1);
%---------------------------
p2_hat = obj4.PComponents(2);
mu2_hat = obj4.mu(2,:);
Sigma2_hat = obj4.Sigma(:,:,2);
%---------------------------
p3_hat = obj4.PComponents(3);
mu3_hat = obj4.mu(3,:);
Sigma3_hat = obj4.Sigma(:,:,3);
%----------------------------
p4_hat = obj4.PComponents(4);
mu4_hat = obj4.mu(4,:);
Sigma4_hat = obj4.Sigma(:,:,4);
%---------------------------
x1 = 0:0.25:10;
x2 = 0:0.25:10;
[X1,X2] = meshgrid(x1,x2);
F4 = p1_hat*mvnpdf([X1(:) X2(:)],mu1_hat,Sigma1_hat) + p2_hat*mvnpdf([X1(:) X2(:)],mu2_hat,Sigma2_hat) + p3_hat*mvnpdf([X1(:) X2(:)],mu3_hat,Sigma3_hat) + p4_hat*mvnpdf([X1(:) X2(:)],mu4_hat,Sigma4_hat);
F4 = reshape(F4,length(x2),length(x1));
%------------------------------
subplot(7,8,[20 21 28 29])
surf(x1,x2,F4);
caxis([min(F4(:))-.5*range(F4(:)),max(F4(:))]);
xlabel('x_1','Fontsize',14); ylabel('x_2','Fontsize',14)
%--------------------------------
subplot(7,8,[44 45 52 53])
contour(x1,x2,F4),axis square,axis([0 10 0 10]),xlabel('x_1','Fontsize',14); ylabel('x_2','Fontsize',14)
subplot(7,8,12:13)
axis off
text(0,0.8,['K = ' num2str(K) ':  Estimation of GMM'],'Fontsize',20)
text(-0.15,0.45,'(see estimated parameters p_k, {\mu}_k, {\Sigma}_k in Command Window)','Fontsize',12)
...
text(0,-0.1,'contour plot of estimated GMM pdf','Fontsize',14)
%----------------------------------------------------
% K = 4: assign observations to clusters using MAP
%----------------------------------------------------
idx4 = cluster(obj4,X);
idx4_cluster_1 = (find(idx4 == 1))'
n4_cluster_1 = length(idx4_cluster_1)
disp('---------------------------------------------------------------------')
idx4_cluster_2 = (find(idx4 == 2))'
n4_cluster_2 = length(idx4_cluster_2)
disp('---------------------------------------------------------------------')
idx4_cluster_3 = (find(idx4 == 3))'
n4_cluster_3 = length(idx4_cluster_3)
disp('---------------------------------------------------------------------')
idx4_cluster_4 = (find(idx4 == 4))'
n4_cluster_4 = length(idx4_cluster_4)
disp('---------------------------------------------------------------------')
K4_cluster_1 = X(idx4_cluster_1,:);
K4_cluster_2 = X(idx4_cluster_2,:);
K4_cluster_3 = X(idx4_cluster_3,:);
K4_cluster_4 = X(idx4_cluster_4,:);
subplot(7,8,[23 24 31 32])
plot(K4_cluster_1(:,1),K4_cluster_1(:,2),'r*','LineWidth',1),xlim([0 10]),ylim([0 10]),grid,axis square,xlabel('x_1','Fontsize',14),ylabel('x_2','Fontsize',14)
hold on
plot(K4_cluster_2(:,1),K4_cluster_2(:,2),'b*','LineWidth',1)
plot(K4_cluster_3(:,1),K4_cluster_3(:,2),'g*','LineWidth',1)
plot(K4_cluster_4(:,1),K4_cluster_4(:,2),'m*','LineWidth',1)
hold off
%----------------------------------------------------
% K = 4: illustrate posteriors
%----------------------------------------------------
posterior_probs = posterior(obj4,X);
K4_posteriors_cluster_1 = posterior_probs(idx4_cluster_1,:);
K4_posteriors_cluster_2 = posterior_probs(idx4_cluster_2,:);
K4_posteriors_cluster_3 = posterior_probs(idx4_cluster_3,:);
K4_posteriors_cluster_4 = posterior_probs(idx4_cluster_4,:);
subplot(7,8,[47 48 55 56])
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,1),'r','LineWidth',3),xlim([0 n+1]),ylim([-0.1 1.1]),grid,axis square,xlabel('observation','Fontsize',14),ylabel('probability','Fontsize',14)
hold on
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,2),'b','LineWidth',1)
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,3),'g','LineWidth',1)
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,4),'m','LineWidth',1)
plot(n4_cluster_1+1:n4_cluster_1+n4_cluster_2,K4_posteriors_cluster_2(:,1),'r','LineWidth',1)
plot(n4_cluster_1+1:n4_cluster_1+n4_cluster_2,K4_posteriors_cluster_2(:,2),'b','LineWidth',3)
plot(n4_cluster_1+1:n4_cluster_1+n4_cluster_2,K4_posteriors_cluster_2(:,3),'g','LineWidth',1)
plot(n4_cluster_1+1:n4_cluster_1+n4_cluster_2,K4_posteriors_cluster_2(:,4),'m','LineWidth',1)
plot(n4_cluster_1+n4_cluster_2+1:n4_cluster_1+n4_cluster_2+n4_cluster_3,K4_posteriors_cluster_3(:,1),'r','LineWidth',1)
plot(n4_cluster_1+n4_cluster_2+1:n4_cluster_1+n4_cluster_2+n4_cluster_3,K4_posteriors_cluster_3(:,2),'b','LineWidth',1)
plot(n4_cluster_1+n4_cluster_2+1:n4_cluster_1+n4_cluster_2+n4_cluster_3,K4_posteriors_cluster_3(:,3),'g','LineWidth',3)
plot(n4_cluster_1+n4_cluster_2+1:n4_cluster_1+n4_cluster_2+n4_cluster_3,K4_posteriors_cluster_3(:,4),'m','LineWidth',1)
plot(n4_cluster_1+n4_cluster_2+n4_cluster_3+1:n,K4_posteriors_cluster_4(:,1),'r','LineWidth',1)
plot(n4_cluster_1+n4_cluster_2+n4_cluster_3+1:n,K4_posteriors_cluster_4(:,2),'b','LineWidth',1)
plot(n4_cluster_1+n4_cluster_2+n4_cluster_3+1:n,K4_posteriors_cluster_4(:,3),'g','LineWidth',1)
plot(n4_cluster_1+n4_cluster_2+n4_cluster_3+1:n,K4_posteriors_cluster_4(:,4),'m','LineWidth',3)
hold off
subplot(7,8,15:16)
axis off
text(0.03,0.8,'Clustering with GMM','Fontsize',20)
...
subplot(7,8,15:16)
axis off
text(0.34,0.7,'K = 4','Fontsize',28)
text(0.15,0,'clustering and posteriors','Fontsize',14)
subplot(7,8,[17 18 25 26])
plot(K2_cluster_1(:,1),K2_cluster_1(:,2),'r*','LineWidth',1),xlim([0 10]),ylim([0 10]),grid,axis square
hold on
plot(K2_cluster_2(:,1),K2_cluster_2(:,2),'b*','LineWidth',1)
hold off
...
hold off
subplot(7,8,[20 21 28 29])
plot(K3_cluster_1(:,1),K3_cluster_1(:,2),'r*','LineWidth',1),xlim([0 10]),ylim([0 10]),grid,axis square
hold on
plot(K3_cluster_2(:,1),K3_cluster_2(:,2),'b*','LineWidth',1)
plot(K3_cluster_3(:,1),K3_cluster_3(:,2),'g*','LineWidth',1)
hold off
...
hold off
subplot(7,8,[23 24 31 32])
plot(K4_cluster_1(:,1),K4_cluster_1(:,2),'r*','LineWidth',1),xlim([0 10]),ylim([0 10]),grid,axis square
hold on
plot(K4_cluster_2(:,1),K4_cluster_2(:,2),'b*','LineWidth',1)
plot(K4_cluster_3(:,1),K4_cluster_3(:,2),'g*','LineWidth',1)
plot(K4_cluster_4(:,1),K4_cluster_4(:,2),'m*','LineWidth',1)
hold off
subplot(7,8,[39 40 47 48])
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,1),'r','LineWidth',3),xlim([0 n+1]),ylim([-0.1 1.1]),grid,axis square,xlabel('observation','Fontsize',10),ylabel('probability','Fontsize',10)
hold on
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,2),'b','LineWidth',1)
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,3),'g','LineWidth',1)
plot(1:n4_cluster_1,K4_posteriors_cluster_1(:,4),'m','LineWidth',1)
...
text(0.21,-0.65,['BIC = ' num2str(BIC_2_clusters,4) '  (K=2 best BIC)'],'Fontsize',14)
subplot(7,8,52:53)
axis off
K = 3;
...
text(0.21,-0.65,['BIC = ' num2str(BIC_3_clusters,4)],'Fontsize',14)
subplot(7,8,55:56)
axis off
K = 4;
logL_4_clusters = -obj4.NlogL;
Npar_4_clusters = K*(1+p*(p+3)/2)-1;
AIC_4_clusters = -obj4.AIC;
BIC_4_clusters = -obj4.BIC;
text(0.21,0.45,['2*log L_m_a_x = ' num2str(2*logL_4_clusters,4)],'Fontsize',14)
text(0.21,0.08,['N_p_a_r = ' num2str(Npar_4_clusters)],'Fontsize',14)
text(0.21,-0.31,['AIC = ' num2str(AIC_4_clusters,4)],'Fontsize',14)
text(0.21,-0.65,['BIC = ' num2str(BIC_4_clusters,4)],'Fontsize',14)
