clc;clear;close all
format compact
load('C:\Users\cv\OneDrive - Syddansk Universitet\M-drive moved by SDU-IT\Statistik\MULTISTAT\Lektion 11  Multiple level LDA + QDA\Course material\dataset_problem_11_1')
%------------------------------------------------------------------------
% Three populations, different mu, different SIGMA
%------------------------------------------------------------------------
g = 3;
p = 2;
n1 = 50;
...
%------------------------------------------------------------------------
figure('Name','Three populations, different mu, different SIGMA')
subplot(4,3,1:3)
axis off
text(0,1.1,'Discriminant Analysis (classification) for three (g=3) bivariate (p=2) populations','Fontsize',24)
...
plot(X1(:,1),X1(:,2),'ro','LineWidth',3),grid,xlim([1.5 4.5]),ylim([0 3])
...
%------------------------------------------------------------------------
% Bartlett test for equal covariance matrices for all populations
%------------------------------------------------------------------------
figure('Name','Bartlett and MANOVA tests ---> QDA')
subplot(5,3,[4 7 10])
...
%------------------------------------------------------------------------
% QDA: Quadratic discriminant function for equal priors and costs
%------------------------------------------------------------------------
...
plot(X2(:,1),X2(:,2),'bo','LineWidth',3)
plot(X3(:,1),X3(:,2),'g*','LineWidth',3)
text(0.5,2.75,'d_1_2(x) = 0','Color','k','Fontsize',20)
text(0.5,2.5,'d_1_3(x) = 0','Color','m','Fontsize',20)
text(0.5,2.25,'d_2_3(x) = 0','Color','c','Fontsize',20)
annotation('arrow',[0.118125 0.151875],...
    [0.66354081632653 0.663265306122449],'HeadLength',15,'HeadWidth',15,...
    'LineWidth',6);
annotation('arrow',[0.116875 0.150625],...
    [0.61292857142857 0.612653061224489],'HeadLength',15,'HeadWidth',15,...
    'LineWidth',6,...
    'Color',[1 0 1]);
annotation('arrow',[0.11875 0.1525],...
    [0.566142857142855 0.565867346938774],'HeadLength',15,'HeadWidth',15,...
    'LineWidth',6,...
    'Color',[0 1 1]);
text(0.5,0.75,'X_1~N_2({\mu}_1,{\Sigma})','Color','r','Fontsize',16)
text(0.5,0.5,'X_2~N_2({\mu}_2,{\Sigma})','Color','b','Fontsize',16)
text(0.5,0.25,'X_3~N_2({\mu}_3,{\Sigma})','Color','g','Fontsize',16)
contour(y1,y2,F1,C1,'Color','r','LineWidth',1)
contour(z1,z2,F2,C2,'Color','b','LineWidth',1)
contour(u1,u2,F3,C3,'Color','g','LineWidth',1)
...
quad_coeffs_d3_QDA = -0.5*inv(S3);
lin_coeffs_d3_QDA = x3_avg*inv(S3);
const_coeff_d3_QDA = -0.5*log(det(S3)) - 0.5*x3_avg*inv(S3)*x3_avg';
text(3.6,0.8,['d_1^Q^D^A(x_1,x_2) = ' num2str(quad_coeffs_d1_QDA(1,1),3) '*x_1^2 +'],'Fontsize',10)
text(4.1,0.67,[num2str(quad_coeffs_d1_QDA(2,2),3) '*x_2^2 +'],'Fontsize',10)
text(4.1,0.55,[num2str(2*quad_coeffs_d1_QDA(1,2),3) '*x_1*x_2 +'],'Fontsize',10)
text(4.1,0.45,[num2str(lin_coeffs_d1_QDA(1),3) '*x_1 +'],'Fontsize',10)
text(4.1,0.35,[num2str(lin_coeffs_d1_QDA(2),3) '*x_2 +'],'Fontsize',10)
text(4.1,0.25,num2str(const_coeff_d1_QDA,3),'Fontsize',10)
text(3.6,1.8,['d_2^Q^D^A(x_1,x_2) = ' num2str(quad_coeffs_d2_QDA(1,1),3) '*x_1^2 +'],'Fontsize',10)
text(4.1,1.67,[num2str(quad_coeffs_d2_QDA(2,2),3) '*x_2^2 +'],'Fontsize',10)
text(4.1,1.55,[num2str(2*quad_coeffs_d2_QDA(1,2),3) '*x_1*x_2 +'],'Fontsize',10)
text(4.1,1.45,[num2str(lin_coeffs_d2_QDA(1),3) '*x_1 +'],'Fontsize',10)
text(4.1,1.35,[num2str(lin_coeffs_d2_QDA(2),3) '*x_2 +'],'Fontsize',10)
text(4.1,1.25,num2str(const_coeff_d2_QDA,3),'Fontsize',10)
text(3.6,2.8,['d_3^Q^D^A(x_1,x_2) = ' num2str(quad_coeffs_d3_QDA(1,1),3) '*x_1^2 +'],'Fontsize',10)
text(4.1,2.67,[num2str(quad_coeffs_d3_QDA(2,2),3) '*x_2^2 +'],'Fontsize',10)
text(4.1,2.55,[num2str(2*quad_coeffs_d3_QDA(1,2),3) '*x_1*x_2 +'],'Fontsize',10)
text(4.1,2.45,[num2str(lin_coeffs_d3_QDA(1),3) '*x_1 +'],'Fontsize',10)
text(4.1,2.35,[num2str(lin_coeffs_d3_QDA(2),3) '*x_2 +'],'Fontsize',10)
text(4.1,2.25,num2str(const_coeff_d3_QDA,3),'Fontsize',10)
hold off
%------------------------------------------------------------------------
...
d3_QDA_x0_1 = x0_1'*quad_coeffs_d3_QDA*x0_1 + lin_coeffs_d3_QDA*x0_1 + const_coeff_d3_QDA
disp('Conclusion: d2(x0_1) > d1(x0_1),d3(x0_1) => classify as member of population 2')
posterior_prob_x0_1_member_of_pop_1 = mvnpdf(x0_1,x1_avg',S1)/(mvnpdf(x0_1,x1_avg',S1) + mvnpdf(x0_1,x2_avg',S2) + mvnpdf(x0_1,x3_avg',S3))
posterior_prob_x0_1_member_of_pop_2 = mvnpdf(x0_1,x2_avg',S2)/(mvnpdf(x0_1,x1_avg',S1) + mvnpdf(x0_1,x2_avg',S2) + mvnpdf(x0_1,x3_avg',S3))
posterior_prob_x0_1_member_of_pop_3 = mvnpdf(x0_1,x3_avg',S3)/(mvnpdf(x0_1,x1_avg',S1) + mvnpdf(x0_1,x2_avg',S2) + mvnpdf(x0_1,x3_avg',S3))
disp('Conclusion: P(pop 2 | x0_1) > P(pop 1 | x0_1),P(pop 3 | x0_1) => classify as member of population 2')
disp('---------------------------------------------------------------------')
...
d3_QDA_x0_2 = x0_2'*quad_coeffs_d3_QDA*x0_2 + lin_coeffs_d3_QDA*x0_2 + const_coeff_d3_QDA
disp('Conclusion: d3(x0_2) > d1(x0_2),d2(x0_2) => classify as member of population 3')
posterior_prob_x0_2_member_of_pop_1 = mvnpdf(x0_2,x1_avg',S1)/(mvnpdf(x0_2,x1_avg',S1) + mvnpdf(x0_2,x2_avg',S2) + mvnpdf(x0_2,x3_avg',S3))
posterior_prob_x0_2_member_of_pop_2 = mvnpdf(x0_2,x2_avg',S2)/(mvnpdf(x0_2,x1_avg',S1) + mvnpdf(x0_2,x2_avg',S2) + mvnpdf(x0_2,x3_avg',S3))
posterior_prob_x0_2_member_of_pop_3 = mvnpdf(x0_2,x3_avg',S3)/(mvnpdf(x0_2,x1_avg',S1) + mvnpdf(x0_2,x2_avg',S2) + mvnpdf(x0_2,x3_avg',S3))
disp('Conclusion: P(pop 3 | x0_2) > P(pop 1 | x0_2),P(pop 2 | x0_2) => classify as member of population 3')
disp('---------------------------------------------------------------------')
...
d3_QDA_x0_3 = x0_3'*quad_coeffs_d3_QDA*x0_3 + lin_coeffs_d3_QDA*x0_3 + const_coeff_d3_QDA
disp('Conclusion: d2(x0_3) > d1(x0_3),d3(x0_3) => classify as member of population 2')
posterior_prob_x0_3_member_of_pop_1 = mvnpdf(x0_3,x1_avg',S1)/(mvnpdf(x0_3,x1_avg',S1) + mvnpdf(x0_3,x2_avg',S2) + mvnpdf(x0_3,x3_avg',S3))
posterior_prob_x0_3_member_of_pop_2 = mvnpdf(x0_3,x2_avg',S2)/(mvnpdf(x0_3,x1_avg',S1) + mvnpdf(x0_3,x2_avg',S2) + mvnpdf(x0_3,x3_avg',S3))
posterior_prob_x0_3_member_of_pop_3 = mvnpdf(x0_3,x3_avg',S3)/(mvnpdf(x0_3,x1_avg',S1) + mvnpdf(x0_3,x2_avg',S2) + mvnpdf(x0_3,x3_avg',S3))
disp('Conclusion: P(pop 2 | x0_3) > P(pop 1 | x0_3),P(pop 3 | x0_3) => classify as member of population 2')
disp('---------------------------------------------------------------------')
%------------------------------------------------------------------------
% LDA for comparison
% Bartlett test for equal covariance matrices for both populations
%------------------------------------------------------------------------
figure('Name','Bartlett and MANOVA tests ---> LDA')
subplot(5,3,[4 7 10])
plot(X1(:,1),X1(:,2),'ro','LineWidth',3),grid,axis equal
xlabel('x_i_1_j,  (i=1,2,3)  (j=1,...,n_i)','Fontsize',12); ylabel('x_i_2_j','Fontsize',12)
hold on
...
text(0,0.1,['t = ' num2str(test_statistic,3)],'Color','k','Fontsize',14)
text(0,0,['p-value = P(T > t) = ' num2str(p_value,3) '   (where T ~ {\chi}^2_(_g_-_1_)_p_(_p_+_1_)_/_2)'],'Color','k','Fontsize',14)
text(0,-0.2,'CONCLUSION:  H_0 is (for comparison between QDA and LDA) ACCEPTED  =>  LDA case','Fontsize',14)
%------------------------------------------------------------------------
% MANOVA test for significant separation of populations
%------------------------------------------------------------------------
subplot(5,3,[11 12 14 15])
...
coeffs_d3_LDA = [x3_avg*inv(Sp) -0.5*x3_avg*inv(Sp)*x3_avg']; 
text(3.6,0.85,['d_1^L^D^A(x_1,x_2) = ' num2str(coeffs_d1_LDA(1),3) '*x_1 +'],'Fontsize',10)
text(4.08,0.7,[num2str(coeffs_d1_LDA(2),3) '*x_2 +'],'Fontsize',10)
text(4.08,0.58,num2str(coeffs_d1_LDA(3),3),'Fontsize',10)
text(3.6,1.85,['d_2^L^D^A(x_1,x_2) = ' num2str(coeffs_d2_LDA(1),3) '*x_1 +'],'Fontsize',10)
text(4.08,1.7,[num2str(coeffs_d2_LDA(2),3) '*x_2 +'],'Fontsize',10)
text(4.08,1.58,num2str(coeffs_d2_LDA(3),3),'Fontsize',10)
text(3.6,2.85,['d_3^L^D^A(x_1,x_2) = ' num2str(coeffs_d3_LDA(1),3) '*x_1 +'],'Fontsize',10)
text(4.08,2.7,[num2str(coeffs_d3_LDA(2),3) '*x_2 +'],'Fontsize',10)
text(4.08,2.58,num2str(coeffs_d3_LDA(3),3),'Fontsize',10)
hold off
%------------------------------------------------------------------------
% Calculate confusion matrix and APER for training data
%------------------------------------------------------------------------
...
d3_LDA_x0_1 = coeffs_d3_LDA*[x0_1; 1]
disp('Conclusion: d2(x0_1) > d1(x0_1),d3(x0_1) => classify as member of population 2 (same as QDA)')
posterior_prob_x0_1_member_of_pop_1 = mvnpdf(x0_1,x1_avg',Sp)/(mvnpdf(x0_1,x1_avg',Sp) + mvnpdf(x0_1,x2_avg',Sp) + mvnpdf(x0_1,x3_avg',Sp))
posterior_prob_x0_1_member_of_pop_2 = mvnpdf(x0_1,x2_avg',Sp)/(mvnpdf(x0_1,x1_avg',Sp) + mvnpdf(x0_1,x2_avg',Sp) + mvnpdf(x0_1,x3_avg',Sp))
posterior_prob_x0_1_member_of_pop_3 = mvnpdf(x0_1,x3_avg',Sp)/(mvnpdf(x0_1,x1_avg',Sp) + mvnpdf(x0_1,x2_avg',Sp) + mvnpdf(x0_1,x3_avg',Sp))
disp('Conclusion: P(pop 2 | x0_1) > P(pop 1 | x0_1),P(pop 3 | x0_1) => classify as member of population 2')
disp('---------------------------------------------------------------------')
...
d3_LDA_x0_2 = coeffs_d3_LDA*[x0_2; 1]
disp('Conclusion: d2(x0_2) > d1(x0_2),d3(x0_2) => classify as member of population 2 (different from QDA)')
posterior_prob_x0_2_member_of_pop_1 = mvnpdf(x0_2,x1_avg',Sp)/(mvnpdf(x0_2,x1_avg',Sp) + mvnpdf(x0_2,x2_avg',Sp) + mvnpdf(x0_2,x3_avg',Sp))
posterior_prob_x0_2_member_of_pop_2 = mvnpdf(x0_2,x2_avg',Sp)/(mvnpdf(x0_2,x1_avg',Sp) + mvnpdf(x0_2,x2_avg',Sp) + mvnpdf(x0_2,x3_avg',Sp))
posterior_prob_x0_2_member_of_pop_3 = mvnpdf(x0_2,x3_avg',Sp)/(mvnpdf(x0_2,x1_avg',Sp) + mvnpdf(x0_2,x2_avg',Sp) + mvnpdf(x0_2,x3_avg',Sp))
disp('Conclusion: P(pop 2 | x0_2) > P(pop 1 | x0_2),P(pop 3 | x0_2) => classify as member of population 2')
disp('---------------------------------------------------------------------')
disp('Classification of new observation 3 with LDA')
x0_3
d1_LDA_x0_3 = coeffs_d1_LDA*[x0_3; 1]
d2_LDA_x0_3 = coeffs_d2_LDA*[x0_3; 1]
d3_LDA_x0_3 = coeffs_d3_LDA*[x0_3; 1]
disp('Conclusion: d2(x0_3) > d1(x0_3),d3(x0_3) => classify as member of population 2 (same as QDA)')
posterior_prob_x0_3_member_of_pop_1 = mvnpdf(x0_3,x1_avg',Sp)/(mvnpdf(x0_3,x1_avg',Sp) + mvnpdf(x0_3,x2_avg',Sp) + mvnpdf(x0_3,x3_avg',Sp))
posterior_prob_x0_3_member_of_pop_2 = mvnpdf(x0_3,x2_avg',Sp)/(mvnpdf(x0_3,x1_avg',Sp) + mvnpdf(x0_3,x2_avg',Sp) + mvnpdf(x0_3,x3_avg',Sp))
posterior_prob_x0_3_member_of_pop_3 = mvnpdf(x0_3,x3_avg',Sp)/(mvnpdf(x0_3,x1_avg',Sp) + mvnpdf(x0_3,x2_avg',Sp) + mvnpdf(x0_3,x3_avg',Sp))
disp('Conclusion: P(pop 2 | x0_3) > P(pop 1 | x0_3),P(pop 3 | x0_3) => classify as member of population 2')
disp('---------------------------------------------------------------------')
%-------------------------------------------------------------------------------------------------------